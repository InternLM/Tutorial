...
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230222238.png)

然后往下翻，找到 Variables and secrets，找到右上角创建 New secret
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230222401.png)
这里我们输入两个 api_key，一个是 `token` ——你的浦语/硅基流动 api，一个是 `weather_token` ——你的和风天气 api，要注意名称不要写错。
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230222936.png)

然后点击 Save 就保存好你的密钥了。
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230223159.png)
...
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230225352.png)
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230225421.png)
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230225444.png)
...
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230223340.png)
然后我们现在就有三个环境变量了
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230223614.png)
...
可以看到，就这么水灵灵的就暴露出来了 ![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241230224142.png)
那么 Secret 呢
```
import streamlit as st
import os
...
griffe==0.48.0
```
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241219175535.png)

不过实测发现 huggingfaces 上的 docker 找不到 `requirements/optional.txt` 和 `requirements/runtime.txt`
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223085959.png)
...
griffe==0.48.0
```
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223091226.png)


由于 Huggingface Spaces 要求 file 中必须有一个名称为 `app.py` 的文件，否则会出现 `No application file` 错误。
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223085618.png)
...
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223090819.png)
...
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223092958.png)
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223092847.png)
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223092907.png)
![](https://github.com/fresh-little-lemon/image/tree/main/InternML-Tutorial/Pasted%20image%2020241223092818.png)
