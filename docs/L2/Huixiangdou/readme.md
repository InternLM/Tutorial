...
- [0 茴香豆介绍](#0-茴香豆介绍)
- [1 Web 版茴香豆](#1-web-版茴香豆)
  - [1.1 创建 Web 版茴香豆账户和密码](#11-创建-web-版茴香豆账户和密码)
  - [1.2 创建 Web 版茴香豆知识库](#12-创建-web-版茴香豆知识库)
  - [1.3 通过配置正反例调优知识助手效果](#13-通过配置正反例调优知识助手效果)
  - [1.4 （选做）在微信群或飞书群内使用茴香豆助手](#14-选做在微信群或飞书群内使用茴香豆助手)
  - [1.5 （选做）搭建自己的 web 版茴香豆](#15-选做搭建自己的-web-版茴香豆)
- [2 茴香豆本地标准版搭建](#2-茴香豆本地标准版搭建)
  - [ 2.1 环境搭建](#-21-环境搭建)
    - [2.1.1 配置服务器](#211-配置服务器)
    - [2.1.2 搭建茴香豆虚拟环境](#212-搭建茴香豆虚拟环境)
  - [2.2  安装茴香豆](#22--安装茴香豆)
    - [2.2.1 下载茴香豆](#221-下载茴香豆)
    - [2.2.2 安装茴香豆所需依赖](#222-安装茴香豆所需依赖)
    - [2.2.3 下载模型文件](#223-下载模型文件)
    - [2.2.4 更改配置文件](#224-更改配置文件)
  - [2.3 知识库创建](#23-知识库创建)
  - [2.4 测试知识助手](#24-测试知识助手)
    - [2.4.1 命令行运行](#241-命令行运行)
    - [2.4.2 Gradio UI 界面测试](#242-gradio-ui-界面测试)
  - [2.5 （选做）集成飞书\&微信群聊](#25-选做集成飞书微信群聊)
- [3 茴香豆高阶应用（选做）](#3-茴香豆高阶应用选做)
  - [3.1 开启网络搜索](#31-开启网络搜索)
  - [3.2 远程模型](#32-远程模型)
    - [3.2.1 远程向量\&重排序模型](#321-远程向量重排序模型)
    - [3.2.2 远程大模型](#322-远程大模型)
  - [~~ 3.3 多模态版本测试（始终不通过，等军佬确定是否可行）~~](#-33-多模态版本测试始终不通过等军佬确定是否可行)
- [](#)
- [实战项目](#实战项目)
- [挑战项目](#挑战项目)

**PPT 地址：https://1drv.ms/p/s!AlAIlKoW9ghjsR0ZUI\_arULICdAG?e=DNt3vO**
